    ...
    <div class="col-md-10">
        <div class="pull-center">
            ...
            @endif
                ...
                @endif 
 <!-----------------------form content---------------------------->   
 <form  method="POST" action="/updating_prod_data/<?php foreach($get_editable_data as $val){ echo $val->id; } ?>" enctype="multipart/form-data">
            {{csrf_field()}}
           
            <div class="row">
                    <div class="mb-3 col-md-6">
                        <label class="form-label" for="inputPassword4" style="font-size:16px">Product Category</label>
                        <input type="text" name="name" value="<?php foreach($get_editable_data as $val){ echo $val->name; } ?>" class="form-control my-colorpicker1" disabled> 
                    </div>
                        <div class="mb-3 col-md-6">
                        <label class="form-label" for="inputPassword4" style="font-size:16px">Title</label>
                        <input type="text" name="title" class="form-control my-colorpicker1"  value="<?php foreach($get_editable_data as $val){ echo $val->title; } ?>"> 
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <label class="form-label" for="inputPassword4" style="font-size:16px">Class</label>
                        <input type="text" name="class" class="form-control my-colorpicker1"  value="<?php foreach($get_editable_data as $val){ echo $val->class; } ?>">
                    </div>
                        <div class="mb-3 col-md-6">
                        <label class="form-label" for="inputPassword4" style="font-size:16px">Price</label>
                        <input type="text" name="price" class="form-control my-colorpicker1"  value="<?php foreach($get_editable_data as $val){ echo $val->price; } ?>"> 
                    </div>
                </div>
                <div class="row">
                    <div class="mb-3 col-md-6">
                    <label class="form-label" for="inputPassword4" style="font-size:16px">Image</label>
                        <input type="file" name="image" value="<?php foreach($get_editable_data as $val){ echo $val->image; } ?>" class="form-control my-colorpicker1"  >
                    </div>
                        <div class="mb-3 col-md-6">
                        <label class="form-label" for="inputPassword4" style="font-size:16px">Available Stock</label>
                        <input type="text" name="available_stock" class="form-control my-colorpicker1" value="<?php foreach($get_editable_data as $val){ echo $val->available_stock; } ?>" >
                    </div>
                </div>
 
                <div class="row">
                    <div class="mb-3 col-md-6">
                    <a href="/single_prod_data/<?php foreach($get_editable_data as $val){ echo $val->prod_cat_id; }?>" class="btn btn-secondary btn-block" >Back</a>
                    </div>
                        <div class="mb-3 col-md-6">
