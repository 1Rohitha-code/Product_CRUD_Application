...
@section('content')
 ...
 <form  method="POST" action="/store_cat_data_form" enctype="multipart/form-data">
            {{csrf_field()}}
           
            <div class="row">
                    <div class="mb-3 col-md-12">
                        <label class="form-label" for="inputPassword4" style="font-size:16px">Product Category</label>
                        <input type="text" name="name" class="form-control my-colorpicker1"  placeholder="Category name"> 
                    </div>
                        <div class="mb-3 col-md-12">
